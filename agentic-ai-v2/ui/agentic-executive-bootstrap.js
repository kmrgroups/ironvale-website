...
(function(){
  ...
  var installed=false, panelReady=false;

  function visiblePanel(){
    var panels=[].slice.call(document.querySelectorAll('.panel'));
    panels.forEach(function(p){ p.classList.toggle('on', p===document.getElementById(PANEL_ID)); });
  }
  ...
  function installMenu(){
    ...
    g.querySelector('[data-agentic-executive-link]').addEventListener('click',function(e){
      e.preventDefault();
      openExecutive();
    });
  }
