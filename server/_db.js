...
export async function ensureTables() {
  ...
  await sql.transaction([
    ...
    /* Self sign-up — see the copy under server/server/. A login somebody
       created for themselves is inactive until a developer administrator
       approves it, and signup_at tells an account awaiting approval apart from
       one an administrator deliberately deactivated. */
