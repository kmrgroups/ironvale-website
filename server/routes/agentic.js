...
import { sql, ensureTables, tokenUser, cors, readBody } from '../../api/_db.js';

const ROOT = path.dirname(new URL(import.meta.url).pathname);
const REGISTRY = JSON.parse(fs.readFileSync(path.join(ROOT, '../agentic-ai-v2/agent-registry.json'), 'utf8'));
const POLICY = JSON.parse(fs.readFileSync(path.join(ROOT, '../agentic-ai-v2/action-policy.json'), 'utf8'));
